                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="header">
                                            <h4 class="title">Editar Usuário {{ $data->email }}</h4>
                                        </div>
                                        <div class="content">
                                            <form method="POST" action="/users/update/{{ $data->id }}" accept-charset="UTF-8">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group"><label for="email">E-mail</label><b style="color:red">*</b>
                                                        <input placeholder="Ex: john@domain.com" class="form-control" name="email" type="email" id="email" value="{{ $data->email }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group"><label for="password">Senha</label>
                                                        <input class="form-control" name="password" type="password" value="" id="password" value="">
                                                        </div>
                                                    </div>
                                                </div>
                                                <hr />
                                                <button class="btn btn-info btn-fill pull-right">Editar</button>
